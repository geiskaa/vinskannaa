...
let currentPage = parseInt(dashboardMeta.dataset.currentPage || "1");
let hasMore = dashboardMeta.dataset.hasMore === "true";
let isLoading = false;
...
function toggleFavorite(productId) {
    ...
    console.log(
        `Product ID: ${productId}, is_favorited: ${currentIsFavorited}`
    );
